...
mixin _$ChatMessage {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, role, content, createdAt, sessionId);

  @override
  String toString() {
    return 'ChatMessage(id: $id, role: $role, content: $content, createdAt: $createdAt, sessionId: $sessionId)';
  }
}
...
extension ChatMessagePatterns on ChatMessage {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, ChatRole role, String content,
            DateTime createdAt, String? sessionId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
